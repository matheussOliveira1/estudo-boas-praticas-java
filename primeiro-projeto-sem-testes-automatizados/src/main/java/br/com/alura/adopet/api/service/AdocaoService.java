...
public class AdocaoService {
    ...
    @Autowired
    private List<ValidacaoSolicitacaoAdocao> validacoesSolicitacoesAdocao;

    public void solicitar(SolicitacaoAdocaoDto dto) {
        Pet pet = petRepository.getReferenceById(dto.idPet());
        Tutor tutor = tutorRepository.getReferenceById(dto.idTutor());

        validacoesSolicitacoesAdocao.forEach(v -> v.validar(dto));
    ...
    public void aprovar(AprovacaoAdocaoDto dto) {
        ...
        adocao.marcarAdocaoComoAprovado();
    ...
    public void reprovar(ReprovacaoAdocaoDto dto) {
        ...
        adocao.marcarAdocaoComoReprovado(dto.justificativa());
